                        ...
                        <>
                            <div className="survey-input-field my-2">
                                ...
                                <div className="dynamic-sec">
                                    ...
                                    <span style={{ fontSize: '24px', cursor: 'pointer' }} onClick={handleAddSurvey}><IoIosAddCircleOutline /></span>
                                </div>
                                            ...
                                            <div key={item.id} className='survey-exp-main'>
                                                <div className="dyn-input-sec py-1">
                                                    ...
                                                    <div className="dyn-icon-sec">
                                                        <span className='survey-edit' title='edit' style={{ fontSize: '24px', padding: '0px 7px', cursor: 'pointer' }} onClick={() => setExpression(!showExpression)}><BsPencil /></span>
                                                        <span className='survey-del' title='delete' onClick={() => handlesurveydel(item.id)} style={{ fontSize: '24px', padding: '0px 7px', cursor: 'pointer' }}><BsFillTrashFill /></span>
                                                    </div>
                                ...
                                <div className="main-survey2 my-2">
                                    <div className="main-survey2-content">
                                        ...
                                        <span style={{ fontSize: '24px', cursor: 'pointer' }} className='py-2' onClick={handleexpAdd}><IoIosAddCircleOutline /></span>
                                    </div>
                                    {expData.map((item) => {
                                        return (
